...
"""
Base class for all SpotMasterMessage... classes
:author: Pete Zybrick
...
class SpotMasterMessageBase(object):
    """Base class for all SpotMasterMessage... classes"""
    ...
    def __init__( self,
        ...
        self.spot_master_sqs_message_durable = SqsMessageDurable( self.spot_master_queue_name, self.region_name, profile_name=self.profile_name )
